...
var HTMLCanvasElementLuminanceSource = /** @class */
function (_super) {
...
function () {
  ...
  BrowserCodeReader2.createCaptureCanvas = function (mediaElement) {
    ...
    var _a = BrowserCodeReader2.getMediaElementDimensions(mediaElement),
      width = _a.width,
      height = _a.height;
...
var BrowserAztecCodeReader = /** @class */
function (_super) {
...
var BrowserMultiFormatOneDReader = /** @class */
function (_super) {
...
var BrowserDatamatrixCodeReader = /** @class */
function (_super) {
...
import { DecodeHintType as DecodeHintType2, MultiFormatReader } from "@zxing/library";
...
var BrowserMultiFormatReader = /** @class */
function (_super) {
  ...
  Object.defineProperty(BrowserMultiFormatReader2.prototype, "possibleFormats", {
    set: function (formats) {
      this.hints.set(DecodeHintType2.POSSIBLE_FORMATS, formats);
...
import { EncodeHintType, IllegalArgumentException as IllegalArgumentException2, IllegalStateException, QRCodeDecoderErrorCorrectionLevel, QRCodeEncoder } from "@zxing/library";
var svgNs = "http://www.w3.org/2000/svg";
var BrowserCodeSvgWriter = /** @class */
function () {
  ...
  BrowserCodeSvgWriter2.prototype.write = function (contents, width, height, hints) {
    if (contents.length === 0) {
      throw new IllegalArgumentException2("Found empty contents");
    }
    if (width < 0 || height < 0) {
      throw new IllegalArgumentException2("Requested dimensions are too small: " + width + "x" + height);
    }
...
import { EncodeHintType as EncodeHintType2, IllegalArgumentException as IllegalArgumentException3, IllegalStateException as IllegalStateException2, QRCodeDecoderErrorCorrectionLevel as QRCodeDecoderErrorCorrectionLevel2, QRCodeEncoder as QRCodeEncoder2 } from "@zxing/library";
var svgNs2 = "http://www.w3.org/2000/svg";
var BrowserQRCodeSvgWriter = /** @class */
function () {
  function BrowserQRCodeSvgWriter2() {}
  BrowserQRCodeSvgWriter2.prototype.write = function (contents, width, height, hints) {
    if (contents.length === 0) {
      throw new IllegalArgumentException3("Found empty contents");
    }
    if (width < 0 || height < 0) {
      throw new IllegalArgumentException3("Requested dimensions are too small: " + width + "x" + height);
    }
    var errorCorrectionLevel = QRCodeDecoderErrorCorrectionLevel2.L;
    var quietZone = BrowserQRCodeSvgWriter2.QUIET_ZONE_SIZE;
    if (hints) {
      if (void 0 !== hints.get(EncodeHintType2.ERROR_CORRECTION)) {
        var correctionStr = hints.get(EncodeHintType2.ERROR_CORRECTION).toString();
        errorCorrectionLevel = QRCodeDecoderErrorCorrectionLevel2.fromString(correctionStr);
      }
      if (void 0 !== hints.get(EncodeHintType2.MARGIN)) {
        quietZone = Number.parseInt(hints.get(EncodeHintType2.MARGIN).toString(), 10);
      }
    }
    var code = QRCodeEncoder2.encode(contents, errorCorrectionLevel, hints);
    return this.renderResult(code, width, height, quietZone);
  };
  ...
  BrowserQRCodeSvgWriter2.prototype.renderResult = function (code, width, height, quietZone) {
    var input = code.getMatrix();
    if (input === null) {
      throw new IllegalStateException2();
    }
    var inputWidth = input.getWidth();
    var inputHeight = input.getHeight();
    var qrWidth = inputWidth + quietZone * 2;
...
export { BarcodeFormat, BrowserAztecCodeReader, BrowserCodeReader, BrowserCodeSvgWriter, BrowserDatamatrixCodeReader, BrowserMultiFormatOneDReader, BrowserMultiFormatReader, BrowserPDF417Reader, BrowserQRCodeReader, BrowserQRCodeSvgWriter, HTMLCanvasElementLuminanceSource };